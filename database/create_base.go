...
const (
  ...
  IDP_ADMIN = `CREATE TABLE idp_admins (
    ...
    job_state int(2) DEFAULT 1 COMMENT '职位状态：1试用期、2转正、3离职',
    entry_time INT(11) DEFAULT NULL COMMENT '入职时间',
    trial_time INT(11) DEFAULT NULL COMMENT '试用期时间',
    contract_time INT(11) DEFAULT NULL COMMENT '合同到期时间',
    quit_time INT(11) DEFAULT NULL COMMENT '离职时间',
